// 5x5 Line Buffer for 28x28 Images (MNIST)
module line_buffer_5x5 (
    ...
    // Window outputs (25 pixels). w_R_C (Row R, Column C)
    output signed [15:0] w00, output signed [15:0] w01, output signed [15:0] w02, output signed [15:0] w03, output signed [15:0] w04,
    output signed [15:0] w10, output signed [15:0] w11, output signed [15:0] w12, output signed [15:0] w13, output signed [15:0] w14,
    output signed [15:0] w20, output signed [15:0] w21, output signed [15:0] w22, output signed [15:0] w23, output signed [15:0] w24,
    output signed [15:0] w30, output signed [15:0] w31, output signed [15:0] w32, output signed [15:0] w33, output signed [15:0] w34,
    output signed [15:0] w40, output signed [15:0] w41, output signed [15:0] w42, output signed [15:0] w43, output signed [15:0] w44,
    ...
    reg signed [15:0] row0 [0:IMG_WIDTH-1];
    ...
    // Row and Column counters for valid signal control
    reg [4:0] col_cnt; // 0 to 27
    reg [4:0] row_cnt; // 0 to 27
    ...
    always @(posedge clock or posedge reset) begin
        if (reset) begin
            ...
            for (i=0; i<IMG_WIDTH; i=i+1) begin
                row0[i] <= 16'd0; row1[i] <= 16'd0; row2[i] <= 16'd0; row3[i] <= 16'd0; row4[i] <= 16'd0;
            end
    ...
    // Map shift registers to window outputs
